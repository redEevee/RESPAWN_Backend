...
public class GradePolicy {
    ...
    private static final long THRESHOLD_VIP  = 10_000L;  // 예시
    private static final long THRESHOLD_VVIP = 30_000L;  // 예시
    private static final long THRESHOLD_VVIP_PLUS = 50_000L; // 예시 (50 이상은 동일 취급)
